# Клуб медоедов (Medoyid Club)

Школа развития и личностного роста — онлайн-курсы, лекции и семинары. На последующих этапах — социальная RPG-среда с картой мира, профилями персонажей, квестами и матчингом по интересам и типу личности.

Планируемый домен: `medoyid-club.com` (пока не подключён).
